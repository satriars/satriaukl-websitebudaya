...
<html lang="en">
  ...
  <body>
    ...
    <section id="tarian" class="menu">
        ...
        <p>
          Di bawah ini adalah beberapa tarian adat yang berasal dari Jawa Timur.
        </p>
  
        <div class="row">
          <div class="menu-card">
            <img src="tari reog.jpg" >
            <h3 class="menu-card-title">- Tari Reog Ponorogo</h3>
          </div>
          <div class="menu-card">
            <img
              src="tari jombang.jpg"
              class="menu-card-img"
            />
            <h3 class="menu-card-title">- Tari remo, Jombang</h3>
          </div>
          <div class="menu-card">
            <img
              src="tari dari sampang.jpg"
              class="menu-card-img"
            />
            <h3 class="menu-card-title">-Tari muang sungkal, Sumenep-Madura </h3>
